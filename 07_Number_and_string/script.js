...
document.getElementById('btn_erase').addEventListener('click', function () {
...
document.getElementById('btn_radix').addEventListener('click', function () {
    const radix = Math.sqrt(inputWindow.value);
    inputWindow.value = radix;  
})